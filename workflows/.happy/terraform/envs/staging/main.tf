...
module "stack" {
  ...
  additional_env_vars = {
    ...
    IDENTITY_SERVICE_BASE_URL                             = "http://staging.czid.org"
    ...
    PLATFORMICS_WORKFLOW_RUNNER__SWIPE__OUTPUT_S3_PREFIX  = "s3://idseq-samples-staging/nextgen/"
    PLATFORMICS_WORKFLOW_RUNNER__SWIPE__STATE_MACHINE_ARN = "arn:aws:states:us-west-2:${var.aws_account_id}:stateMachine:idseq-swipe-staging-default-wdl"
    PLATFORMICS_EVENT_BUS__SWIPE__SQS_QUEUE_URL           = "https://sqs.us-west-2.amazonaws.com/${var.aws_account_id}/idseq-swipe-staging-nextgen-web-sfn-notifications-queue"
