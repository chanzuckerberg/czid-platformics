...
module "stack" {
  ...
  additional_env_vars = {
    ...
    PLATFORMICS_EVENT_BUS__SWIPE__SQS_QUEUE_URL           = "https://sqs.us-west-2.amazonaws.com/${var.aws_account_id}/idseq-swipe-development-nextgen-web-sfn-notifications-queue"
