...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["workflow_id"], ["workflow.id"], name=op.f("fk_workflow_version_workflow_id_workflow")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("PENDING", "STARTED", "RUNNING", "SUCCEEDED", "FAILED", name="runstatus"), nullable=False
        ),
        sa.Column("workflow_version_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["workflow_version_id"], ["workflow_version.id"], name=op.f("fk_run_workflow_version_id_workflow_version")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_run")),
    )
    op.create_table(
        "workflow_version_input",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("workflow_version_id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["workflow_version_id"],
            ["workflow_version.id"],
            name=op.f("fk_workflow_version_input_workflow_version_id_workflow_version"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_workflow_version_input")),
    )
    op.create_table(
        "workflow_version_output",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("workflow_version_id", sa.Integer(), nullable=False),
        sa.Column("name", sa.String(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["workflow_version_id"],
            ["workflow_version.id"],
            name=op.f("fk_workflow_version_output_workflow_version_id_workflow_version"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["workflow_version_input.id"],
            name=op.f("fk_run_entity_input_workflow_version_input_id_workflow_version_input"),
        ),
