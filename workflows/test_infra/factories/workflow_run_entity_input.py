"""
Factory for generating WorkflowRunEntityInput objects.
...
import factory
from database.models import WorkflowRunEntityInput
...
class WorkflowRunEntityInputFactory(CommonFactory):
    class Meta:
        sqlalchemy_session = None  # workaround for a bug in factoryboy
        model = WorkflowRunEntityInput
