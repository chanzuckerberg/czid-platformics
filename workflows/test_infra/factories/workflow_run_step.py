"""
Factory for generating WorkflowRunStep objects.
...
import factory
from database.models import WorkflowRunStep
...
class WorkflowRunStepFactory(CommonFactory):
    class Meta:
    ...
    status = fuzzy.FuzzyChoice(["RUNNING", "SUCCEEDED", "FAILED"])
