...
async def main(
    collection_id: int, user_id: int, message_type: str, runner_id: str, outputs_json: str, seed: bool
) -> None:
    ...
    if seed:
        ...
        ds.seed_workflow_runs(message_type, runner_id)
...
if __name__ == "__main__":
    ...
    loop.run_until_complete(
        main(args.collection_id, args.user_id, args.message_type, args.runner_id, args.outputs_json, args.seed)
    )
