...
class RunWhereClause(TypedDict):
    ...
    workflow_version: Optional[Annotated["WorkflowVersionWhereClause", strawberry.lazy("api.types.workflow_version")]] | None
    run_steps: Optional[Annotated["RunStepWhereClause", strawberry.lazy("api.types.run_step")]] | None
    run_entity_inputs: Optional[Annotated["RunEntityInputWhereClause", strawberry.lazy("api.types.run_entity_input")]] | None
...
class Run(EntityInterface):
    ...
    workflow_version: Optional[Annotated["WorkflowVersion", strawberry.lazy("api.types.workflow_version")]] = load_workflow_version_rows  # type:ignore
    run_steps: Sequence[Annotated["RunStep", strawberry.lazy("api.types.run_step")]] = load_run_step_rows  # type:ignore
    run_entity_inputs: Sequence[Annotated["RunEntityInput", strawberry.lazy("api.types.run_entity_input")]] = load_run_entity_input_rows  # type:ignore
