...
class ContigWhereClause(sgqlc.types.Input):
    __schema__ = gql_schema
    __field_names__ = ('id', 'producing_run_id', 'owner_user_id', 'collection_id', 'sequencing_read', 'sequence', 'entity_id')
...
class SampleWhereClause(sgqlc.types.Input):
    __schema__ = gql_schema
    __field_names__ = ('id', 'producing_run_id', 'owner_user_id', 'collection_id', 'name', 'location', 'sequencing_reads', 'entity_id')
    id = sgqlc.types.Field('UUIDComparators', graphql_name='id')
    producing_run_id = sgqlc.types.Field(IntComparators, graphql_name='producingRunId')
    owner_user_id = sgqlc.types.Field(IntComparators, graphql_name='ownerUserId')
    collection_id = sgqlc.types.Field(IntComparators, graphql_name='collectionId')
...
class SequencingReadWhereClause(sgqlc.types.Input):
    __schema__ = gql_schema
    __field_names__ = ('id', 'producing_run_id', 'owner_user_id', 'collection_id', 'nucleotide', 'sequence', 'protocol', 'sample', 'contigs', 'entity_id')
    id = sgqlc.types.Field('UUIDComparators', graphql_name='id')
    producing_run_id = sgqlc.types.Field(IntComparators, graphql_name='producingRunId')
    owner_user_id = sgqlc.types.Field(IntComparators, graphql_name='ownerUserId')
    collection_id = sgqlc.types.Field(IntComparators, graphql_name='collectionId')
...
class File(sgqlc.types.Type):
    __schema__ = gql_schema
    __field_names__ = ('id', 'entity_id', 'entity_field_name', 'entity', 'status', 'protocol', 'namespace', 'path', 'file_format', 'compression_type', 'size', 'download_link')
    id = sgqlc.types.Field(sgqlc.types.non_null(UUID), graphql_name='id')
...
class Mutation(sgqlc.types.Type):
    __schema__ = gql_schema
    __field_names__ = ('create_sample', 'create_sequencing_read', 'update_sample', 'create_file', 'upload_file', 'mark_upload_complete')
    ...
    create_sequencing_read = sgqlc.types.Field(sgqlc.types.non_null('SequencingRead'), graphql_name='createSequencingRead', args=sgqlc.types.ArgDict((
        ('nucleotide', sgqlc.types.Arg(sgqlc.types.non_null(Nucleotide), graphql_name='nucleotide', default=None)),
        ('sequence', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='sequence', default=None)),
        ('protocol', sgqlc.types.Arg(sgqlc.types.non_null(SequencingProtocol), graphql_name='protocol', default=None)),
        ('sequence_file_id', sgqlc.types.Arg(sgqlc.types.non_null(UUID), graphql_name='sequenceFileId', default=None)),
        ('collection_id', sgqlc.types.Arg(sgqlc.types.non_null(Int), graphql_name='collectionId', default=None)),
))
    )
...
class Sample(sgqlc.types.Type, EntityInterface):
    __schema__ = gql_schema
    __field_names__ = ('producing_run_id', 'owner_user_id', 'collection_id', 'name', 'location', 'sequencing_reads', 'entity_id')
    producing_run_id = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='producingRunId')
    owner_user_id = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='ownerUserId')
    collection_id = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='collectionId')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
...
class SequencingRead(sgqlc.types.Type, EntityInterface):
    __schema__ = gql_schema
    __field_names__ = ('producing_run_id', 'owner_user_id', 'collection_id', 'nucleotide', 'sequence', 'protocol', 'sequence_file_id', 'sequence_file', 'sample', 'contigs', 'entity_id')
    producing_run_id = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='producingRunId')
    owner_user_id = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='ownerUserId')
    collection_id = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='collectionId')
    ...
    sequence_file = sgqlc.types.Field(sgqlc.types.non_null(File), graphql_name='sequenceFile', args=sgqlc.types.ArgDict((
        ('where', sgqlc.types.Arg(FileWhereClause, graphql_name='where', default=None)),
))
    )
