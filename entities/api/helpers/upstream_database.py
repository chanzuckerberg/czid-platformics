...
def build_upstream_database_groupby_output(
    group_object: Optional[UpstreamDatabaseGroupByOptions],
    keys: list[str],
    value: Any,
) -> UpstreamDatabaseGroupByOptions:
    """
    Given a list of (potentially nested) fields representing the key of a groupby query and the value,
    build the proper groupby object.
    """
    if not group_object:
        group_object = UpstreamDatabaseGroupByOptions()
