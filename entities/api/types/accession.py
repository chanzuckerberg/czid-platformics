...
async def resolve_accessions(
    ...
    return await get_db_rows(db.Accession, session, cerbos_client, principal, where, order_by, CerbosAction.VIEW, limit, offset)  # type: ignore


def format_accession_aggregate_output(query_results: Sequence[RowMapping] | RowMapping) -> AccessionAggregate:
    """
