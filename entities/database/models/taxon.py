...
class Taxon(Entity):
    ...
    tax_parent_id: Mapped[uuid.UUID] = mapped_column(UUID, ForeignKey("taxon.entity_id"), nullable=True, index=True)
    tax_parent: Mapped["Taxon"] = relationship("Taxon", foreign_keys=tax_parent_id)
    tax_subspecies_id: Mapped[uuid.UUID] = mapped_column(UUID, ForeignKey("taxon.entity_id"), nullable=True, index=True)
    tax_subspecies: Mapped["Taxon"] = relationship("Taxon", foreign_keys=tax_subspecies_id)
    tax_species_id: Mapped[uuid.UUID] = mapped_column(UUID, ForeignKey("taxon.entity_id"), nullable=True, index=True)
    tax_species: Mapped["Taxon"] = relationship("Taxon", foreign_keys=tax_species_id)
    tax_genus_id: Mapped[uuid.UUID] = mapped_column(UUID, ForeignKey("taxon.entity_id"), nullable=True, index=True)
    tax_genus: Mapped["Taxon"] = relationship("Taxon", foreign_keys=tax_genus_id)
    tax_family_id: Mapped[uuid.UUID] = mapped_column(UUID, ForeignKey("taxon.entity_id"), nullable=True, index=True)
    tax_family: Mapped["Taxon"] = relationship("Taxon", foreign_keys=tax_family_id)
    tax_order_id: Mapped[uuid.UUID] = mapped_column(UUID, ForeignKey("taxon.entity_id"), nullable=True, index=True)
    tax_order: Mapped["Taxon"] = relationship("Taxon", foreign_keys=tax_order_id)
    tax_class_id: Mapped[uuid.UUID] = mapped_column(UUID, ForeignKey("taxon.entity_id"), nullable=True, index=True)
    tax_class: Mapped["Taxon"] = relationship("Taxon", foreign_keys=tax_class_id)
    tax_phylum_id: Mapped[uuid.UUID] = mapped_column(UUID, ForeignKey("taxon.entity_id"), nullable=True, index=True)
    tax_phylum: Mapped["Taxon"] = relationship("Taxon", foreign_keys=tax_phylum_id)
    tax_kingdom_id: Mapped[uuid.UUID] = mapped_column(UUID, ForeignKey("taxon.entity_id"), nullable=True, index=True)
    ...
    tax_superkingdom_id: Mapped[uuid.UUID] = mapped_column(
        UUID, ForeignKey("taxon.entity_id"), nullable=True, index=True
    )
